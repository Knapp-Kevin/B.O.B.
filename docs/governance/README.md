...
B.O.B. governance is intentionally lightweight but explicit. Its purpose is to preserve product boundaries, user authority, predictable AI cost, and documentation truthfulness.
...
Governance should make the correct small change easier to identify. If governance begins producing more work than the feature it is protecting, simplify the governance rather than abandoning the boundary.
